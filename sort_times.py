...
import plotter
import time
from sorts import quickSort, quick_insertion_sort
from sorts_2 import insertion_sort, merge_sort, quick_sort
...
sort_functions = [insertion_sort, merge_sort, quick_sort]
